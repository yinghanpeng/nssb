...
@Controller
@RequestMapping("/nssbManager")
public class NssbManagerController {
	...
	public ModelAndView main() {
		...
		ModelAndView mv = new ModelAndView("pages/nssbManager/nssbManager");
...
//		}
		...
		if(awftMap == null){
			...
			mv = new ModelAndView("pages/nssbManager/nssbManager");
		}
		mv.addObject("awftMap", awftMap);
		mv.addObject("bmmc", bmmc);
		return mv;
